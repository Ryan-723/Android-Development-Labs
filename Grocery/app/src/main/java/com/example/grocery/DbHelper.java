...
import com.example.ndggrocery.Util.Purchase;
import com.example.ndggrocery.Util.Sale;
import com.example.ndggrocery.Util.StockItem;
import com.example.ndggrocery.Util.User;

public class DbHelper extends SQLiteOpenHelper {
    // db settings
    private static final String TAG = "DbDebug";
    private static final String DBNAME = "ndggrocery.db";
